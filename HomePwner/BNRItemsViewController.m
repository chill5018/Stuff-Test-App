...
- (instancetype)init
{
    ...
    if (self) {
        ...
        navItem.title = NSLocalizedString(@"StuffLoggr", @"Name of application");
...
- (void)viewDidLoad
{
    ...
    // Load the NIB file to go to the Original Table View Cell (I need to register the Collection View Cell as well as the default homescreen
